										...
										<table class="display" id="table-device">
											...
											<tbody>
												<tr>
													...
													<td>
														<button class="btn btn-sm btn-light" onclick="return alertModal('includes/php/functionInstance.php?logout=1', 'Logout', 'If you logout maybe any data cant be saved!')">
